...
(function () {
  ...
  if (form) {
    form.addEventListener('submit', function (e) {
      ...
      setTimeout(function () {
        ...
        var to = (window.ZD_CONTENT && window.ZD_CONTENT.contact && window.ZD_CONTENT.contact.email) || 'info@zadalog.com';
  ...
  if (wa) { wa.href = waHref(); T.onChange(function () { wa.href = waHref(); }); }
