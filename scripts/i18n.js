...
window.I18N = (function () {
  ...
  var HE = {
    ...
    tickerTitle: 'חדר מבצעים · חי', tickerFoot: 'מתעדכן כל כמה שניות', scroll: 'גללו',
    ...
    trBtn: 'מעקב',
    trHint: 'הזינו את מספר ה‑B/L או מספר ההזמנה שקיבלתם מאיתנו.',
  ...
  var EN = {
    ...
    tickerTitle: 'Ops room · live', tickerFoot: 'Updates every few seconds', scroll: 'Scroll',
    ...
    trBtn: 'Track',
    trHint: 'Enter the B/L or booking number you received from us.',
